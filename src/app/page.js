    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex justify-between items-center">
          <div className="text-2xl font-bold text-blue-600">HealthNet Pro</div>
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Connect with doctors, nurses, technicians, and healthcare
            professionals. Share knowledge, find opportunities, and grow your
            career.
          </p>
        ...
        <div id="features" className="mt-32 grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Connect with healthcare professionals across specialties. Grow
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Discover job openings at top hospitals and healthcare facilities.
              Apply with ease.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Post updates, articles, and insights. Learn from industry experts
              and peers.
            </p>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-8 mt-20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">
            © 2024 HealthNet Pro. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
